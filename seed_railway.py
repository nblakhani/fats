...
visits = [
    ...
    dict(st="Ajay Kumar Pandey", cl="Larsen & Toubro",      ago=0, tin="10:30", tout="11:30", vt="Prospecting",  rep="Anand Rao, Purchase Head",               pur="Introduce Maini material handling — scissor lifts and stackers",        prev="First meeting. L&T building new Ranchi warehouse.",               act="Arrange Maini scissor lift demo at L&T warehouse",      help=None,                                                          fu=10, pri="Medium", notes="Anand interested. Wants demo before deciding.", lob="Material Handling",),
    dict(st="Ajay Kumar Pandey", cl="ACC Ltd",              ago=1, tin="10:00", tout="11:15", vt="Follow-up",    rep="Ramesh Gupta, Purchase Manager",         pur="Timken bearing order follow-up — 12 units for cement mill",             prev="Quotation submitted. PO delayed due to budget freeze.",           act="Stay in touch — budget resumes July",                   help=None,                                                          fu=30, pri="Medium", notes="Budget freeze until July. Revisit then.", lob="Industrial Bearings",),
    dict(st="Ajay Kumar Pandey", cl="DVC",                  ago=2, tin="09:00", tout="10:00", vt="Prospecting",  rep="A.K. Ghosh, Chief Engineer",             pur="Explore industrial fan and motor requirements — 4 power stations",     prev="Lead from industry exhibition last month.",                       act="Prepare Marathon motor spec sheet vs Siemens",          help=None,                                                          fu=7,  pri="Medium", notes="DVC open to quotes. Currently buying from Siemens.", lob="Motors & Fans",),
    ...
    dict(st="Ajay Kumar Pandey", cl="ACC Ltd",              ago=7, tin="09:30", tout="10:30", vt="Sales call",   rep="Ramesh Gupta, Purchase Manager",         pur="Atlas Copco air dryer proposal for cement plant",                       prev="Bearings discussed. New opportunity identified.",                 act="Submit Atlas Copco FD series dryer quotation",          help=None,                                                          fu=14, pri="Low",    notes="Cement dust causing compressor issues. Dryer will help.", lob="Compressed Air",),
